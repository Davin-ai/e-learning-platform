...
export default function AdminArticles() {
  ...
  const saveArticlesAsDraft = (event) => {
            ...
            <div class="col-12">
              <div class="bottom-form">
                <div class="submit-btn">
                  ...
                  <input type="submit" value="پیش نویس" className='m-1' onClick={saveArticlesAsDraft} />
                </div>
              </div>
            </div>
          </form>
          ...
          <tbody>
            {
              articles.map((article, index) => (
                <tr>
                  ...
                  <td>
                    <button type='button' className='btn btn-danger delete-bin' onClick={() => removeArticle(article._id)}>
                      حذف
                    </button>
                  </td>
                </tr>
