            ...
            <section className="login-register">
                <div className="login">
                    ...
                    <form action="#" className="login-form">
                        ...
                        <Button className={`login-form__btn ${(formState.isFormValid && isReCaptchaValid) ? 'login-form__btn-success' : 'login-form__btn-error'}`} type="submit" onClick={loginUser} disabled={(!formState.isFormValid || !isReCaptchaValid)}>
