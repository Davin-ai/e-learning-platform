  ...
  return (
    <>
      ...
      <Breadcrumb
        links={[
          { id: 1, title: 'خانه', to: '' },
          { id: 2, title: 'مقاله ها', to: 'category-info/:categoryName' },
          { id: 3, title: 'ری اکت vs ویو', to: 'course-info/:courseName' },
        ]}
      />
              ...
              <div className="article">
                ...
                <div className="article__header">
                  ...
                  <div className="article-header__category article-header__item">
                    ...
                    <span className="article-header__text"> {creator.name}</span>
                  </div>
                  {/* <div className="article-header__category article-header__item">
