                        ...
                        <>
                            ...
                            <div class="comments__respond">
                                <div class="comments__score">
                                    ...
                                    <div className='col-12'>
                                        <select className='form-select form-control font-bold' onChange={event => setCommentScore(event.target.value)}>
                                            <option className='form-control' value="-1">امتیاز خود را انتخاب کنید</option>
                                ...
                                <div class="comments__respond-content">
                                    ...
                                    <textarea class="comments__score-input-respond" onChange={onChangeHandlder}>
                                        {newCommentBody}
                                    </textarea>
                                </div>
                                <button type="submit" class="comments__respond-btn" onClick={() => submitComment(newCommentBody,commentScore)}>
                                    ارسال
                                </button>
                            </div>
                        </>
